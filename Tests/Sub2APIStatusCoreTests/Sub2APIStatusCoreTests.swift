...
@Test func compactNumberFormatsLargeUnits() {
    #expect(StatusFormatters.compactNumber(1_000_000) == "1.00M")
    #expect(StatusFormatters.compactNumber(1_260_000_000) == "1.26B")
    #expect(StatusFormatters.compactNumber(1_260_000_000_000) == "1.26T")
}
...
@Test func modelUsageDisplaySummarizesCostShareAndUnitEconomics() {
    ...
    #expect(displays[0].tokenMixText == "In 120.00M / Out 50.00M")
...
@Test func usageReportSummarizesShareableUsageWithoutSecrets() {
    ...
    #expect(report.contains("Today Tokens: 126.39M"))
    #expect(report.contains("Input 7.66M / Output 536.1K / Cache Read 118.19M"))
    #expect(report.contains("Cost / MTok: $0.9302/MTok"))
    #expect(report.contains("Codex daily quota: 93%, resets in 2h"))
    #expect(report.contains("Trend 2026-05-18: 1186 requests, 126.39M tokens, $117.5668"))
    #expect(report.contains("Top Models: gpt-5.5 $86.0000 (170.00M tokens), gpt-5.4 $31.5668 (40.00M tokens)"))
...
@Test func socialShareSummaryBuildsViralSafeUsageCardWithoutSecrets() {
    ...
    #expect(summary.title == "126.39M AI tokens today")
    #expect(summary.primaryMetric == "126.39M")
    ...
    #expect(summary.shareText.contains("126.39M AI tokens today"))
